package com.saurabhjadhav.smartcampus.Student.GateEntryExit.models;
...
public class User {
    ...
    public String getCheckOutTime(int a){
        return checkOutTime.getHours() + ":" + checkOutTime.getMinutes() + "  " + checkOutTime.getDate() + "/" + checkInTime.getMonth() + "/" + Calendar.getInstance(TimeZone.getDefault()).get(Calendar.YEAR);
    }
    public String getCheckInTime(int a){
        return checkInTime.getHours() + ":" + checkInTime.getMinutes() + "  " + checkInTime.getDate() + "/" + checkInTime.getMonth() + "/" + Calendar.getInstance(TimeZone.getDefault()).get(Calendar.YEAR);
    }
