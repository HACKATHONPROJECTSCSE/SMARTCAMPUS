package com.saurabhjadhav.smartcampus.Student.DeveloperInfo;
...
public class DeveloperInfoTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_developer_info_teacher);
